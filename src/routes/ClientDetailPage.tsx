...
export default function ClientDetailPage() {
  ...
  const [charts, setCharts] = useState<Record<string, LineSeries[]>>({}); const [apps, setApps] = useState<BarListItem[]>([]); const [uploadApps, setUploadApps] = useState<BarListItem[]>([]); const [events, setEvents] = useState<string[][]>([]); const [eventsLoading, setEventsLoading] = useState(true);
  useEffect(() => {
    let cancelled = false;
