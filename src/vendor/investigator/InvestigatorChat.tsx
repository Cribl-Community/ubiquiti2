...
import { Button, Modal } from '../capra';
import { runInvestigation, type LoopEvent } from '../agent-loop';
import {
...
} from './InvestigatorTranscript';
import { exportAsPng } from './exportInvestigation';
